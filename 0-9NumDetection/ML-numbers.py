...
from keras.datasets import mnist #The MNIST dataset of handwritten digits (0-9) ~60k images
...
num_inputs = 784 #1 for each pixel (28 * 28 = 784)
...
images_train = images_train.reshape(images_train.shape[0], num_inputs)
images_test = images_test.reshape(images_test.shape[0], num_inputs)
...
'''
print("Training ...")
#model.fit(images_train, labels_train, epochs=epochs, batch_size=256)
